 ...
 * @param {number} [startIndex=0] Index in data to start searching from
 */
export const findValues = (data, values, startIndex = 0) => {
	for (let dataIndex = startIndex; dataIndex < data.length - values.length + 1; dataIndex++) {
